...
namespace CrowdSourcing {
    ...
    public partial class mainTask1 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(mainTask1).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(mainTask1));
        ...
        private string FindResource() {
            string[] resources = typeof(mainTask1).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".mainTask1.g.xaml") || resource.Equals("mainTask1.g.xaml"))) {
                    return resource;
                }
            }
