...
namespace CrowdSourcing.xaml {
    ...
    public partial class mainTask2 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(mainTask2).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(mainTask2));
        ...
        private string FindResource() {
            string[] resources = typeof(mainTask2).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".mainTask2.g.xaml") || resource.Equals("mainTask2.g.xaml"))) {
                    return resource;
                }
            }
