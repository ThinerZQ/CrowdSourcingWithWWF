...
namespace CrowdSourcing.xaml {
    ...
    public partial class paper_use1 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(paper_use1).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(paper_use1));
        ...
        private string FindResource() {
            string[] resources = typeof(paper_use1).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".paper-use1.g.xaml") || resource.Equals("paper-use1.g.xaml"))) {
                    return resource;
                }
            }
