...
namespace CrowdSourcing.xaml {
    ...
    public partial class try2 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(try2).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(try2));
        ...
        private string FindResource() {
            string[] resources = typeof(try2).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".try2.g.xaml") || resource.Equals("try2.g.xaml"))) {
                    return resource;
                }
            }
