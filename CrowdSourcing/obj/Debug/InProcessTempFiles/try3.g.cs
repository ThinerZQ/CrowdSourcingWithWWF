...
namespace CrowdSourcing.xaml {
    ...
    public partial class try3 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(try3).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(try3));
        ...
        private string FindResource() {
            string[] resources = typeof(try3).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".try3.g.xaml") || resource.Equals("try3.g.xaml"))) {
                    return resource;
                }
            }
