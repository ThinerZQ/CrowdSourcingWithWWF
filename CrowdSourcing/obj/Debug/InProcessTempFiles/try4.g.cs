...
namespace CrowdSourcing.xaml {
    ...
    public partial class try4 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(try4).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(try4));
        ...
        private string FindResource() {
            string[] resources = typeof(try4).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".try4.g.xaml") || resource.Equals("try4.g.xaml"))) {
                    return resource;
                }
            }
