...
namespace CrowdSourcing.xaml {
    ...
    public partial class paper_use : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(paper_use).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(paper_use));
        ...
        private string FindResource() {
            string[] resources = typeof(paper_use).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".paper-use.g.xaml") || resource.Equals("paper-use.g.xaml"))) {
                    return resource;
                }
            }
