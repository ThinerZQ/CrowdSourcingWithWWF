...
namespace CrowdSourcing {
    ...
    public partial class baseActivity3 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(baseActivity3).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(baseActivity3));
        ...
        private string FindResource() {
            string[] resources = typeof(baseActivity3).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".baseActivity3.g.xaml") || resource.Equals("baseActivity3.g.xaml"))) {
                    return resource;
                }
            }
