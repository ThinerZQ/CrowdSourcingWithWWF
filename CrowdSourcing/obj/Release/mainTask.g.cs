...
namespace CrowdSourcing {
    ...
    public partial class mainTask : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(mainTask).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(mainTask));
        ...
        private string FindResource() {
            string[] resources = typeof(mainTask).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".mainTask.g.xaml") || resource.Equals("mainTask.g.xaml"))) {
                    return resource;
                }
            }
